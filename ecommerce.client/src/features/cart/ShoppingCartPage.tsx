            ...
            {cart?.cartItems.map((item) => (
              ...
              >
                <TableCell component="th" scope="row">
                  <img src={`http://localhost:5063/images/${item.imageUrl}`} style={{ height: 60 }} />
                </TableCell>
                <TableCell component="th" scope="row">
                  {item.productName}
                </TableCell>
                ...
                <TableCell align="right">
                  ...
                  {item.quantity}
                  <Button
                    loading={status === "pendingRemoveItem" + item.productId + "single"}onClick={() => dispatch(removeItemFromCart({ productId: item.productId, quantity: 1, key: "single" }))}>
                    <RemoveCircleOutline />
                  </Button>
                </TableCell>
                ...
                <TableCell align="right">
                  <Button
                    ...
                    onClick={() => dispatch(removeItemFromCart({ productId: item.productId, quantity: item.quantity, key: "all" }))}>
                    <Delete />
                  </Button>
                </TableCell>
              </TableRow>
